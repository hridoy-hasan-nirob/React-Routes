...
const Profile = () => {
  ...
  <div className="w3-content" style={{maxWidth: '1100px', marginTop: '80px', marginBottom: '80px'}}>
    ...
    <div className="w3-container">
      ...
      <div className="w3-container w3-dark-grey w3-padding w3-xlarge">
        <div className="w3-left" onclick="plusDivs(-1)"><i className="fa fa-arrow-circle-left w3-hover-text-teal" /></div>
        <div className="w3-right" onclick="plusDivs(1)"><i className="fa fa-arrow-circle-right w3-hover-text-teal" /></div>
        <div className="w3-center">
          <span className="w3-tag demodots w3-border w3-transparent w3-hover-white" onclick="currentDiv(1)" />
          <span className="w3-tag demodots w3-border w3-transparent w3-hover-white" onclick="currentDiv(2)" />
          <span className="w3-tag demodots w3-border w3-transparent w3-hover-white" onclick="currentDiv(3)" />
        </div>
      </div>
    </div>
    {/* Grid */}
  ...
  <footer className="w3-container w3-padding-32 w3-light-grey w3-center">
    <h4>Footer</h4>
    <a href="#" className="w3-button w3-black w3-margin"><i className="fa fa-arrow-up w3-margin-right" />To the top</a>
